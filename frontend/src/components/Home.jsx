    ...
    <div className='flex flex-wrap text-black w-full my-auto justify-center'>
      ...
      <div className='flex flex-col items-start bg-gradient-to-bl from-white to-gray-200/80 rounded-lg shadow-2xl px-4 border-black/20 border-2 w-[56.5%]'>
        ...
        <div className='w-full my-auto '>
          <button className='bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 border-b-4 border-gray-600 hover:border-gray-800 rounded w-40'>
            Update
          </button>
        </div>
      </div>
      <div className='w-[99%] flex flex-row items-start bg-gradient-to-t from-white to-gray-200/80 rounded-lg shadow-2xl px-4 border-black/20 border-2 mx-auto mt-20'>
        <div className='w-[60%] text-start'>
          ...
          <div className='w-full flex'>
            ...
            <input
              type='text'
              value={'Masters 2025 Derby Hunt'}
              className='w-5/12 text-xl 2xl:text-2xl font-medium my-4 ml-auto text-end border-2 border-black/40 rounded-lg'
            />
          </div>
          <div className='w-full flex'>
            <p className='text-xl 2xl:text-2xl font-medium my-4'>
              Dates Held:{' '}
            </p>
            <input
              type='text'
              value={'2025-12-20 to 2025-12-31'}
              className='w-5/12 text-xl 2xl:text-2xl font-medium my-4 ml-auto text-end border-2 border-black/40 rounded-lg'
            />
          </div>
          <div className='w-full flex'>
